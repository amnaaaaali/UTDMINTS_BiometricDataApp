...
# Repeat red and blue line plots for theta band z-scores.
...
# create a line to be plotted on axis 1
line1 = ax1.plot(0, 0)
# create a line to be plotted on axis 1
line2 = ax1.plot(0, 0)
...
def plotNodes(i):
    ...
    # create a numpy array for the amplitudes
    ...
    # print the shape of the z-scores
